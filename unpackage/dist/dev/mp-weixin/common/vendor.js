...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.223.2";
  const port = "8090";
  const id = "mp-weixin_M6Lfj0";
...
const pages = [
  ...
  {
    path: "pages/my-customers/detail",
    style: {
      navigationBarTitleText: "客户详情"
    }
  },
  {
    path: "pages/my-customers/create",
    style: {
      navigationBarTitleText: "新增客户"
    }
  },
  {
    path: "pages/my-customers/edit",
    style: {
      navigationBarTitleText: "编辑客户"
    }
  },
  {
    path: "pages/purchases/create",
    style: {
      navigationBarTitleText: "新增购买"
    }
  },
  {
    path: "pages/purchases/consume",
    style: {
      navigationBarTitleText: "消耗登记"
    }
  },
  {
    path: "pages/bookings/create",
    style: {
      navigationBarTitleText: "新增预约"
    }
  },
  {
    path: "pages/bookings/index",
    style: {
      navigationBarTitleText: "全部预约"
    }
  },
  {
    path: "pages/appointments/next-week",
    style: {
      navigationBarTitleText: "本周预约"
    }
  },
  {
    path: "pages/calendar/index",
    style: {
      navigationBarTitleText: "预约月历"
    }
  },
  {
    path: "pages/analytics/store",
    style: {
      navigationBarTitleText: "门店指标"
    }
  },
  {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.223.2"],"servePort":7001,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","/Applications/HBuilderX-Alpha.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"crm-date","spaceId":"mp-fdba21ff-bad9-47b6-9972-a95e35f46ea2","clientSecret":"SEQ0WVVz3pdX38TL3LEHxw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__4B38155";
} catch (e2) {
