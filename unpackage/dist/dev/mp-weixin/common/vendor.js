...
function initRuntimeSocketService() {
  const hosts = "192.168.31.63,127.0.0.1,172.25.160.1";
  const port = "8090";
  const id = "mp-weixin_-GxT6q";
