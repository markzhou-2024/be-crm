  ...
  methods: {
    async loadData() {
      try {
        ...
        if (!data) {
          common_vendor.index.showToast({ title: "记录不存在", icon: "none" });
          setTimeout(() => common_vendor.index.navigateBack(), 400);
          return;
        }
        this.form = { ...data };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-50883f83"]]);
